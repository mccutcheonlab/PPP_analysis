...
#ticks2=sc.Pars.ts
#
#print(len(ticks1), len(ticks2))
#
##plt.plot(ticks1, ticks2[:2474])
#
#plt.plot(ticks2[:60])
#
#print([np.floor(x) for x in ticks2[:20]])
#
#
#
#
...
time_blue = np.linspace(1, len(data_blue), len(data_blue)) / fs

plt.plot(time_blue, data_blue)
##
